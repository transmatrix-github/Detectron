...
DATA_ROOT=/home/amax/data/securityData/train/Images/
...
mkdir -p $DATA_ROOT/Real-Package_train
mkdir -p $DATA_ROOT/Real-Package_val
for f in train_list;
  do ln -sn $DATA_ROOT/Real-Package/${f} $DATA_ROOT/Real-Package_train/${f}; 
done;

for f in test_list;
  do ln -sn $DATA_ROOT/Real-Package/${f} $DATA_ROOT/Real-Package_val/${f}; 
done;

# process train and test file lists
# 1. generate pair list, and kongbao_list, and error_list
import os
import io
import sys
import json
...
tmp_folder = '/home/amax/data/securityData/tmp_files'


train_sets = ['Alg-Synthesis', 
              'Auto-Software-Synthesis', 
              'Dongle-Synthesis', 
              'Pro-Synthesis', 
              'Real-Package', 
              'Real-Polyhedron', 

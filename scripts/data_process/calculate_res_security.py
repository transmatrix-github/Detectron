...
val_res_file = fullfile(output_root, model_name, 'test/test/%s/generalized_rcnn/bbox_%s_results.json' % val_data)
test_res_file = fullfile(output_root, model_name, 'test/test/%s/generalized_rcnn/bbox_%s_results.json' % test_data)

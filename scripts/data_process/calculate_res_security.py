...
def get_res_folder(model):
    model_map = {
         ...
         's3_rpngf0.4': 'security3_e2e_faster_rcnn_R-101-FPN_rpnfg0.4_1x.yaml',
         's3_rpngf0.3': 'security3_e2e_faster_rcnn_R-101-FPN_rpnfg0.3_1x.yaml',            
         's3_rpngf0.2': 'security3_e2e_faster_rcnn_R-101-FPN_rpnfg0.2_1x.yaml',                                          
